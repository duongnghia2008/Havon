...
def inputf():
    printf(Colorate.Vertical(Colors.yellow_to_green, '''
  ╔═══[Input@Havon]
  ╚══> ''', True), end=' ')
...
def welcome():
  ...
  printf(Center.XCenter(Colorate.Vertical(Colors.green_to_red, f'''
           
                      {random.choice(wms)}
                   WELCOME TO HAVON DDOS       
           ╩══╦═════════════════════════════════╦══╩
    ╔═════════╩═════════════════════════════════╩═════════╗
                      VUI LÒNG LỰA CHỌN
        - help                 |         Xem menu ddos
  ...
  while True:
    ...
    if 'credit' in cmdl:
      ...
      ╔═════════╩═════════════════════════════════╩═════════╗
        ...
        - Bản quyền            : Havon
        - ZALO                 : 0935805066
        - FACEBOOK             : Duongnghiaxchill
                   CẢM ƠN ĐÃ SỬ DỤNG HAVON DDOS
